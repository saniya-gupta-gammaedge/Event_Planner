  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-16">
      ...
      <div className="flex flex-col sm:flex-row items-center sm:items-start gap-10">
        ...
        <div className="space-y-4 text-neutral-700 leading-7 text-center sm:text-left">
          <p>
          ...
          <p>
            We have been giving these services for the last 25 years. In this time we have worked
            on weddings, birthdays, jagran and many other functions across Betul and nearby areas.
          </p>
          <p>
            Over the years, many families in Betul have trusted us for their events. We know what
            it takes to make an event look good and run smoothly, from the first decoration piece
            to the last light.
          </p>
          <p>
          ...
          <p>Call or WhatsApp us to talk about your event and get a price.</p>
        </div>
      </div>
    </div>
  )
